...
def save2(user, contact, personal, student, classStud):
    ...
    if not eduId or not eduSpecId:
        print(f"amea thes save: can not find eduId : {eduId} or eduSpecId: {eduSpecId}. Aborting")
...
def save(user, contact, personal, student, classStud):
    ...
    try:
        ...
        if not eduId or not eduSpec or not classId:
            print(f"amea thes save: can not find eduId : {eduId} or eduSpec: {eduSpec} or classid: {classId} . Aborting")
            return False
